...
// RoleColumns defines and stores column names for table cd_role.
...
var (
	// Role is globally public accessible object for table cd_role operations.
	Role = RoleDao{
		M:     g.DB("admin").Model("cd_role").Safe(),
		DB:    g.DB("admin"),
		Table: "cd_role",
		Columns: roleColumns{
			RoleId:      "role_id",

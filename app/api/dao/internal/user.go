...
// UserColumns defines and stores column names for table prac_user.
...
var (
	// User is globally public accessible object for table prac_user operations.
	User = UserDao{
		M:     g.DB("default").Model("prac_user").Safe(),
		DB:    g.DB("default"),
		Table: "prac_user",
		Columns: userColumns{
			UserId:    "userId",
